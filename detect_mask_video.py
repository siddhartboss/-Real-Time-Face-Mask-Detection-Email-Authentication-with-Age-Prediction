...
prototxtPath = r"C:\Users\lenovo-8\Downloads\Face-Mask-Detection-master\face_detector\deploy.prototxt"
weightsPath = r"C:\Users\lenovo-8\Downloads\Face-Mask-Detection-master\face_detector\res10_300x300_ssd_iter_140000.caffemodel"
 ...
 # -------------
        ...
        if(label == 'No Mask'):
            ...
            if(t == 20):
                ...
                msg['From'] = '2018siddharth.tayde@ves.ac.in'
                msg['To'] = '2018siddharth.tayde@ves.ac.in'
                msg.set_content(
                ...
                with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
                    smtp.login('2018siddharth.tayde@ves.ac.in',
                               '358Siddharth@123')
